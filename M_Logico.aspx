<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="M_Logico.aspx.vb" Inherits="M_Preventivo" %>
                ...
                <table style="width:100%;">
                    <tr>
                        <td bgcolor="#BB1818" class="style12">
                            &nbsp;</td>
                        <td bgcolor="White" class="style13">
                            Agregar Mantenimiento Logico</td>
                    </tr>
                    <tr>
                        <td class="style12">
                            &nbsp;</td>
                ...
                <table style="width:100%;">
                    <tr>
                        <td bgcolor="#BB1818" class="style12">
                            &nbsp;</td>
                        <td bgcolor="White" class="style13">
                            Lista de Mantenimiento Logico</td>
                    </tr>
                    <tr>
                        <td class="style12">
                            &nbsp;</td>
